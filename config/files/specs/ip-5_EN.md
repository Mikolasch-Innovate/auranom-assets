# Technical Specification: IP 5 (ACI)
...
### 3.2. ACI Decision Logic & the 7 Design Elements
...
2.  **Operational Agent (Operative Generation & QA):** For each phase, selects the optimal **consulting method** from a knowledge database (RAG3) and generates on that basis **seven concrete design elements** that serve as binding specifications for the executing agents.

These **seven design elements** are a proprietary core innovation and typically include:
- **Goal & Deliverable**
- **Consulting Tool**
- **Roles & Participants**
- **Venue**
...
2.  **The Generation of the 7 Design Elements:** The concept of decomposing a consulting method into seven concrete, machine-readable specifications that serve as binding instructions for executing agents.
...
| **AI in Consulting** | **Cognitive Automation in Business Consulting (2025)** [2] | This work discusses Gen AI for insight discovery. ACI focuses on the **dynamic configuration of the consulting process itself** through the generation of **7 design elements**. |
